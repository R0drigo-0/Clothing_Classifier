...
class TestCases(unittest.TestCase):
    ...
    def test_02_init_centroids(self):
        for ix, input in enumerate(self.test_cases["input"]):
            km = KMeans(input, self.test_cases["K"][ix])
            km._init_centroids()
    ...
    def test_05_get_centroids(self):
        for ix, input in enumerate(self.test_cases["input"]):
            km = KMeans(input, self.test_cases["K"][ix])
            km._init_centroids()
            km.get_labels()
